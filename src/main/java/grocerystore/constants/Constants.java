...
public class Constants {
    ...
    public static final String USERSEC_SELECTALL_QUERY="SELECT * FROM users_sec";
    public static final String USERSEC_PREP_SELECTONE_QUERY="SELECT * FROM users_sec WHERE ID=?";
    public static final String USERSEC_PREP_SELECTONE_BY_AUTH_QUERY="SELECT * FROM users_sec WHERE EMAIL=? AND PASSWORD=?";
    public static final String USERSEC_PREP_SELECTONE_BY_EMAIL_QUERY="SELECT * FROM users_sec WHERE EMAIL=?";
    ...
    public static final String ROLESEC_SELECTALL_QUERY="SELECT * FROM roles_sec";
    public static final String ROLESEC_PREP_SELECTONE_QUERY="SELECT * FROM roles_sec WHERE ID=?";
    public static final String ROLESEC_PREP_SELECTALL_BY_USERID_QUERY="SELECT ID,ROLENAME from roles_sec,usersandroles where roles_sec.ID=usersandroles.ROLE_ID and USER_ID=?";
    public static final String ROLESEC_PREP_SELECTONE_BY_NAME_QUERY="SELECT * FROM roles_sec WHERE ROLENAME=?";
    public static final String ROLESEC_PREP_INSERT_QUERY="INSERT INTO roles_sec values (?,?)";
    public static final String ROLESEC_PREP_UPDATE_QUERY="UPDATE roles_sec SET ROLENAME=? WHERE ID=?";
    public static final String ROLESEC_PREP_DELETE_QUERY="DELETE FROM roles_sec WHERE ID=?";
